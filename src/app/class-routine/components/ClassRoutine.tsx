...
const syllabusData: ClassRoutineItem [] = [
  
  { id: 1, year: 2025, className: "Nine", fileUrl: "/class-routine/routine-nine.pdf" },
...
const ClassRoutineComponent: React.FC = () => {
  ...
  Comprehensive Classwise Class Routine
</h2>
<p className="text-center text-slate-500 mb-8">
  Explore the official academic Class Routine for each Class, curated for effective learning
</p>
        ...
        <table className="min-w-full border border-slate-200 rounded-lg overflow-hidden">
          <thead className="bg-slate-100">
            <tr>
              ...
              <th className="px-4 py-3 text-center border-b">Class Routine</th>
            </tr>
          </thead>
          <tbody>
